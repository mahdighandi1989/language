...
updated_at: '2026-06-06T07:57:19.264969+00:00'
target_files:
...
1. ورودی‌های مخرب در `userInstructions` نتوانند پرامپت سیستمی را دور بزنند یا تغییر دهند.
2. یک تابع پاکسازی جدید برای ورودی‌های پرامپت کاربر اضافه شود.
3. تست واحد جدید برای سناریوهای تزریق پرامپت اضافه شود.
