...
updated_at: '2026-06-13T08:07:28.902361+00:00'
target_files:
...
1. import { mountFallbacks } from './controllers/index.js' مقدار غیر-undefined برمی‌گرداند
2. server.js بدون ReferenceError/TypeError هنگام boot اجرا می‌شود
3. تست smoke که همهٔ named importهای server.js را بررسی می‌کند اضافه شود
