...
updated_at: '2026-06-13T08:13:37.635476+00:00'
target_files:
...
1. هنگام آپلود فایلی بزرگتر از `MAX_FILE_SIZE`، پیام خطا حجم فایل را به صورت پویا و صحیح نمایش دهد.
2. تغییر `MAX_FILE_SIZE` باعث به‌روزرسانی خودکار پیام خطا شود.
