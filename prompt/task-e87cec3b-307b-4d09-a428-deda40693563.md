...
updated_at: '2026-06-13T08:13:37.892364+00:00'
target_files:
...
- علت: field 
---
[scan #5 at 2026-06-13T08:13:37.804404+00:00]
## 📋 شرح
فیلد `priority` در dataclass/model `Notification` (فایل `backend/app/notifications.py`) تعریف شده ولی هرگز خوانده نمی‌شود.
...
- علت: field de
---
[scan #6 at 2026-06-13T08:13:37.835670+00:00]
## 📋 شرح
فیلد `silent` در dataclass/model `Notification` (فایل `backend/app/notifications.py`) تعریف شده ولی هرگز خوانده نمی‌شود.
...
1. تأیید شد `priority` در هیچ reader مصرف نمی‌شود _(verify: static)_
