---
task_id: d653daea-433a-4829-b267-807b486ae985
title: 🆕 فایل جدید `test_pipeline_logic.py` به هیچ‌جا متصل نیست (orphan)
...
created_at: '2026-06-06T07:59:11.531144+00:00'
updated_at: '2026-06-06T08:06:42.295667+00:00'
target_files:
- tests/backend/ai_llm/test_pipeline_logic.py
---

# 🆕 فایل جدید `test_pipeline_logic.py` به هیچ‌جا متصل نیست (orphan)
...
## 🔍 جزئیات
- 📂 added: `tests/backend/ai_llm/test_pipeline_logic.py`
- 🔥 risk: **medium**
...
---
[scan #2 at 2026-06-06T07:59:11.578769+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `tests/test_firebase_auth.py`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
...
فایل orph
---
[scan #3 at 2026-06-06T07:59:11.602933+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `backend/app/analytics.py`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
...
فایل orphan 
---
[scan #4 at 2026-06-06T07:59:11.627251+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.
...
فایل orphan معمولاً
---
[scan #5 at 2026-06-06T07:59:11.653786+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `tests/test_render_yaml.py`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
...
فایل orphan
---
[scan #6 at 2026-06-06T07:59:11.680320+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.
...
## 🌐 نقشهٔ وابستگی‌ها
فایل جدید `tests/backend/ai_llm/test_pipeline_logic.py` بدون companion.
...
1. بررسی کن فایل `tests/backend/ai_llm/test_pipeline_logic.py` به چه companion ای نیاز دارد و آن را ایجاد یا متصل کن.

## 📤 خروجی مورد انتظار
تغییر کد در فایل‌های مرتبط، commit یا PR جدید با پیام واضح، و عبور تمام معیارهای پذیرش.

## 🧪 دستورات اعتبارسنجی
- `python -m py_compile tests/backend/ai_llm/test_pipeline_logic.py`
- `ruff check tests/backend/ai_llm/test_pipeline_logic.py`
- `pytest -x`
...
2. wiring اضافه شد یا فایل حذف شد _(verify: backend_test)_
