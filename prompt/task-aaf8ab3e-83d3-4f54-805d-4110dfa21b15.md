...
updated_at: '2026-06-06T07:55:56.635903+00:00'
target_files:
...
1. پس از POST /api/upload فایل موقت در uploadDir باقی نمی‌ماند (تست با شمارش فایل‌ها قبل/بعد)
2. پس از POST /api/audio/process هر فایل ورودی و خروجی transcode پاک می‌شود
3. یک job/تابع پاک‌سازی فایل‌های قدیمی‌تر از TTL در uploadDir وجود دارد و تست واحد دارد
