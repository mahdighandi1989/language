---
task_id: 638cc33c-bc27-42b0-9916-b229285dfc2e
...
created_at: '2026-06-13T08:10:56.693403+00:00'
updated_at: '2026-06-13T08:10:56.693405+00:00'
target_files:
...
The 'GROUND_TRUTH' contract, as defined in this file, codifies an under-engineered approach to LLM output robustness and hallucination mitigation. It explicitly states that there is no structured/JSON parser for outputs, validation is structural (not schema-based), and hallucination guards are primarily prompt-level and heuristic. For an AI LLM pipeline, especially one where 'hallucination guards'

📁 file: backend/app/ai_llm/pipeline.py (line 65)
...
- `backend/app/ai_llm/pipeline.py:65`
...
- `backend/app/ai_llm/__init__.py` — این فایل `pipeline.py` را import می‌کند (caller)
...
## 🧪 دستورات اعتبارسنجی
- `python -m py_compile backend/app/ai_llm/pipeline.py`
- `ruff check backend/app/ai_llm/pipeline.py`
- `pytest -x`
