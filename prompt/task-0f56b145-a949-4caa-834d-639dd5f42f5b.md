---
task_id: 0f56b145-a949-4caa-834d-639dd5f42f5b
title: 🆕 فایل جدید `languageService.js` به هیچ‌جا متصل نیست (orphan)
...
created_at: '2026-06-06T07:59:11.915763+00:00'
updated_at: '2026-06-06T08:07:34.769036+00:00'
target_files:
- backend/services/languageService.js
---

# 🆕 فایل جدید `languageService.js` به هیچ‌جا متصل نیست (orphan)
...
## 🔍 جزئیات
- 📂 added: `backend/services/languageService.js`
- 🔥 risk: **medium**
...
---
[scan #2 at 2026-06-06T07:59:11.968925+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `backend/services/liveWsObserver.js`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
...
## 🌐 نقشهٔ وابستگی‌ها
فایل جدید `backend/services/languageService.js` بدون companion.
...
1. بررسی کن فایل `backend/services/languageService.js` به چه companion ای نیاز دارد و آن را ایجاد یا متصل کن.
