---
task_id: d5c96fe6-f07e-4fd9-ae1d-68d99773f218
title: تضاد default برای فیلد 'purpose'
type: bug_fix
priority: high
...
created_at: '2026-06-06T07:55:56.651028+00:00'
updated_at: '2026-06-13T08:10:56.679439+00:00'
---

# تضاد default برای فیلد 'purpose'

## Raw Idea

## 📋 شرح
فیلد `purpose` در `` در دو یا چند جای مختلف default value متفاوت دارد.

## 🤔 چرا مهم است
defaults متناقض باعث می‌شود رفتار سیستم به ترتیب اجرا/import وابسته شود — bug های غیرقابل reproduce.

## 🔍 جزئیات
- علت: field purpose has different defaults: ["== 'Not allowed by CORS'``) and forwarded every other error with", 'logging.getLogger("analytics_log.notifications")', '<name> value=<v>).']
---
[scan #2 at 2026-06-06T07:55:56.663555+00:00]
## 📋 شرح
...
## 🔍 جزئیات
- علت: field else has different defaults: ['len(KEY_FILES)', 'False']
---
[scan #3 at 2026-06-06T07:55:56.668372+00:00]
## 📋 شرح
فیلد `event` در `` در دو یا چند جای مختلف default value متفاوت دارد.

## 🤔 چرا مهم است
defaults متناقض باعث می‌شود رفتار سیستم به ترتیب اجرا/import وابسته شود — bug های غیرقابل reproduce.

## 🔍 جزئیات
- علت: field event has different defaults: ['"normal"', 'None,']
---
[scan #4 at 2026-06-06T07:55:56.673189+00:00]
## 📋 شرح
فیلد `silent` در `` در دو یا چند جای مختلف default value متفاوت دارد.

## 🤔 چرا مهم است
defaults متناقض باعث می‌شود رفتار سیستم به ترتیب اجرا/import وابسته شود — bug های غیرقابل reproduce.

## 🔍 جزئیات
- علت: field silent has different defaults: ['False,', 'False']
---
[scan #5 at 2026-06-06T07:55:56.677924+00:00]
## 📋 شرح
فیلد `missing` در `` در دو یا چند جای مختلف default value متفاوت دارد.

## 🤔 چرا مهم است
defaults متناقض باعث می‌شود رفتار سیستم به ترتیب اجرا/import وابسته شود — bug های غیرقابل reproduce.

## 🔍 جزئیات
- علت: field missing has different defaults: ['[]', '{}']
---
[scan #6 at 2026-06-06T07:55:56.682685+00:00]
## 📋 شرح
...
## 🔍 جزئیات
- علت: field finally has different defaults: ['(BACKEND_DIR / "server.js").read_text(enc
...
- [ ] `purpose` در همه‌جا از یک منبع default می‌گیرد
...
1. گام ۱: همه جاهایی که `purpose` default می‌گیرد لیست کن.
...
1. `purpose` در همه‌جا از یک منبع default می‌گیرد _(verify: static)_
