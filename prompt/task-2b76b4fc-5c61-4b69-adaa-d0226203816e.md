...
updated_at: '2026-06-06T07:55:56.623903+00:00'
target_files:
- package.json
---
...
1. CI/CD در صورت یافتن آسیب‌پذیری‌های حیاتی در وابستگی‌های production، با خطا متوقف شود.
2. تیم توسعه از سیاست جدید آگاه باشد و فرآیند رفع آسیب‌پذیری‌ها را دنبال کند.
