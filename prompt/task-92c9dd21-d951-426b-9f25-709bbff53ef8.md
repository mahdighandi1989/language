...
title: ممیزی commit messages مشکوک و غیراستاندارد
type: other
priority: medium
...
pipeline: ai_llm
purpose: Audit non-standard or suspicious commit messages produced while building the ai_llm pipeline and standardise them.
responsibility: Define the commit-message hygiene checks for the AI/LLM feature work.
expected_inputs: The repository git history and its commit messages.
expected_outputs: A documented list of flagged commits and a standard for future messages.
interacts_with: The repo git history, the other ai_llm pipeline prompts, and the CI quality gates.
created_at: '2026-05-09T07:29:40.376224+00:00'
updated_at: '2026-06-02T17:37:28.930375+00:00'
target_files:
- frontend/index.html
- backend/server.js
---

# ممیزی commit messages مشکوک و غیراستاندارد
