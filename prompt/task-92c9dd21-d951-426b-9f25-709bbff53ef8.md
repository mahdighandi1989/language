...
upstream: کامیت‌های تولیدشده توسط سایر تسک‌های pipeline ai_llm (task-59cbc244, task-7599ae4a, task-8ac8249d, task-2d1f95e8) ورودی این ممیزی هستند.
downstream: مرحلهٔ نظارتی متقاطع (cross-cutting) — راهنمای استاندارد کامیت را برای کل خط‌لوله فراهم می‌کند و تسک دیگری به‌صورت مستقیم به آن وابسته نیست.
---

# ممیزی commit‌های Inspector Bridge Script

<!-- pipeline: ai_llm -->
> **نقش در پایپ‌لاین `ai_llm` (purpose / هدف):** ممیزیِ کیفیت و استانداردِ
> پیام‌های کامیتِ تولیدشده توسط سایر تسک‌های پایپ‌لاین و تعریفِ قالبِ استانداردِ
> کامیت برای جلوگیری از تکرارِ پیام‌های مبهم/غیرِconventional.
> **upstream:** کامیت‌های تولیدشدهٔ `task-59cbc244`, `task-7599ae4a`, `task-8ac8249d`, `task-2d1f95e8`.
> **downstream:** مرحلهٔ نظارتیِ متقاطع؛ راهنمای استانداردِ کامیت را برای کل پایپ‌لاین فراهم می‌کند و تسکِ دیگری مستقیماً به آن وابسته نیست.
