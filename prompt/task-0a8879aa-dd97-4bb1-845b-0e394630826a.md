...
updated_at: '2026-06-13T08:12:02.720479+00:00'
target_files:
- backend/server.js
...
1. درخواست‌های مکرر به /api/telegram/webhook پس از حد مجاز با 429 پاسخ می‌گیرند
2. /api/telegram/link بدنه‌ی نامعتبر (code غیررشته‌ای) را با 400 رد می‌کند
3. تست‌های telegram موجود همچنان pass می‌شوند
