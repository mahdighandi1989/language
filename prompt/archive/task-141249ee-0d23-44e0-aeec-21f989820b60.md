---
task_id: 141249ee-0d23-44e0-aeec-21f989820b60
title: تکمیل تعریف کامپوننت‌های Prompt
type: logic_audit
priority: critical
...
created_at: '2026-05-30T07:41:39.146874+00:00'
updated_at: '2026-06-01T19:29:19.230296+00:00'
archived: true
archived_at: '2026-06-01T19:29:19.230296+00:00'
tags:
- merged
---

# تکمیل تعریف کامپوننت‌های Prompt
...
### Step 1: پر کردن فیلدهای خالی در فایل prompt task-2d1f95e8-b5ea-413f-b1ec-11b7bed6eeb7.md
**Status:** `not_done` (0%)
**Scope:** این مرحله شامل یافتن فایل prompt با شناسه task-2d1f95e8-b5ea-413f-b1ec-11b7bed6eeb7.md در ساختار repo، بررسی محتوای فعلی آن، و پر کردن فیلدهای 'responsibility', 'purpose', 'expected_inputs', 'expected_outputs' و 'interacts_with' است که در حال حاضر خالی هستند. خارج از این مرحله: تغییر سایر فایل‌های prompt، تغییر ساختار کلی pipeline، یا اصلاح فیلدهای غیر از این پنج فیلد. نکته حیاتی: محتوای فیلدها باید با نقش این prompt خاص در pipeline 'ai_llm' هماهنگ باشد و با سایر promptها سازگاری داشته باشد.
**Excerpt:**
```
پنج مورد از شش فایل prompt (task-2d1f95e8-b5ea-413f-b1ec-11b7bed6eeb7.md، task-59cbc244-8dbe-4b9d-9a39-a3633ffd0464.md، task-7599ae4a-1d12-4c87-80c2-b16e5876d9d4.md، task-8ac8249d-e1de-40f8-ad4b-36e271a1b237.md، task-92c9dd21-d951-426b-9f25-709bbff53ef8.md) دارای فیلدهای 'responsibility', 'purpose', 'expected_inputs', 'expected_outputs' و 'interacts_with' خالی هستند.
```

### Step 2: پر کردن فیلدهای خالی در فایل prompt task-59cbc244-8dbe-4b9d-9a39-a3633ffd0464.md
**Status:** `not_done` (0%)
**Scope:** این مرحله شامل یافتن فایل prompt با شناسه task-59cbc244-8dbe-4b9d-9a39-a3633ffd0464.md در ساختار repo، بررسی محتوای فعلی آن، و پر کردن فیلدهای 'responsibility', 'purpose', 'expected_inputs', 'expected_outputs' و 'interacts_with' است که در حال حاضر خالی هستند. خارج از این مرحله: تغییر سایر فایل‌های prompt، تغییر ساختار کلی pipeline، یا اصلاح فیلدهای غیر از این پنج فیلد. نکته حیاتی: محتوای فیلدها باید با نقش این prompt خاص در pipeline 'ai_llm' هماهنگ باشد و با سایر promptها سازگاری داشته باشد.
**Excerpt:**
```
پنج مورد از شش فایل prompt (task-2d1f95e8-b5ea-413f-b1ec-11b7bed6eeb7.md، task-59cbc244-8dbe-4b9d-9a39-a3633ffd0464.md، task-7599ae4a-1d12-4c87-80c2-b16e5876d9d4.md، task-8ac8249d-e1de-40f8-ad4b-36e271a1b237.md، task-92c9dd21-d951-426b-9f25-709bbff53ef8.md) دارای فیلدهای 'responsibility', 'purpose', 'expected_inputs', 'expected_outputs' و 'interacts_with' خالی هستند.
```

### Step 3: پر کردن فیلدهای خالی در فایل prompt task-7599ae4a-1d12-4c87-80c2-b16e5876d9d4.md
**Status:** `not_done` (0%)
**Scope:** این مرحله شامل یافتن فایل prompt با شناسه task-7599ae4a-1d12-4c87-80c2-b16e5876d9d4.md در ساختار repo، بررسی محتوای فعلی آن، و پر کردن فیلدهای 'responsibility', 'purpose', 'expected_inputs', 'expected_outputs' و 'interacts_with' است که در حال حاضر خالی هستند. خارج از این مرحله: تغییر سایر فایل‌های prompt، تغییر ساختار کلی pipeline، یا اصلاح فیلدهای غیر از این پنج فیلد. نکته حیاتی: محتوای فیلدها باید با نقش این prompt خاص در pipeline 'ai_llm' هماهنگ باشد و با سایر promptها سازگاری داشته باشد.
**Excerpt:**
```
پنج مورد از شش فایل prompt (task-2d1f95e8-b5ea-413f-b1ec-11b7bed6eeb7.md، task-59cbc244-8dbe-4b9d-9a39-a3633ffd0464.md، task-7599ae4a-1d12-4c87-80c2-b16e5876d9d4.md، task-8ac8249d-e1de-40f8-ad4b-36e271a1b237.md، task-92c9dd21-d951-426b-9f25-709bbff53ef8.md) دارای فیلدهای 'responsibility', 'purpose', 'expected_inputs', 'expected_outputs' و 'interacts_with' خالی هستند.
```

### Step 4: پر کردن فیلدهای خالی در فایل prompt task-8ac8249d-e1de-40f8-ad4b-36e271a1b237.md
**Status:** `not_done` (0%)
**Scope:** این مرحله شامل یافتن فایل prompt با شناسه task-8ac8249d-e1de-40f8-ad4b-36e271a1b237.md در ساختار repo، بررسی محتوای فعلی آن، و پر کردن فیلدهای 'responsibility', 'purpose', 'expected_inputs', 'expected_outputs' و 'interacts_with' است که در حال حاضر خالی هستند. خارج از این مرحله: تغییر سایر فایل‌های prompt، تغییر ساختار کلی pipeline، یا اصلاح فیلدهای غیر از این پنج فیلد. نکته حیاتی: محتوای فیلدها باید با نقش این prompt خاص در pipeline 'ai_llm' هماهنگ باشد و با سایر promptها سازگاری داشته باشد.
**Excerpt:**
```
پنج مورد از شش فایل prompt (task-2d1f95e8-b5ea-413f-b1ec-11b7bed6eeb7.md، task-59cbc244-8dbe-4b9d-9a39-a3633ffd0464.md، task-7599ae4a-1d12-4c87-80c2-b16e5876d9d4.md، task-8ac8249d-e1de-40f8-ad4b-36e271a1b237.md، task-92c9dd21-d951-426b-9f25-709bbff53ef8.md) دارای فیلدهای 'responsibility', 'purpose', 'expected_inputs', 'expected_outputs' و 'interacts_with' خالی هستند.
```

### Step 5: پر کردن فیلدهای خالی در فایل prompt task-92c9dd21-d951-426b-9f25-709bbff53ef8.md
**Status:** `not_done` (0%)
**Scope:** این مرحله شامل یافتن فایل prompt با شناسه task-92c9dd21-d951-426b-9f25-709bbff53ef8.md در ساختار repo، بررسی محتوای فعلی آن، و پر کردن فیلدهای 'responsibility', 'purpose', 'expected_inputs', 'expected_outputs' و 'interacts_with' است که در حال حاضر خالی هستند. خارج از این مرحله: تغییر سایر فایل‌های prompt، تغییر ساختار کلی pipeline، یا اصلاح فیلدهای غیر از این پنج فیلد. نکته حیاتی: محتوای فیلدها باید با نقش این prompt خاص در pipeline 'ai_llm' هماهنگ باشد و با سایر promptها سازگاری داشته باشد.
**Excerpt:**
```
پنج مورد از شش فایل prompt (task-2d1f95e8-b5ea-413f-b1ec-11b7bed6eeb7.md، task-59cbc244-8dbe-4b9d-9a39-a3633ffd0464.md، task-7599ae4a-1d12-4c87-80c2-b16e5876d9d4.md، task-8ac8249d-e1de-40f8-ad4b-36e271a1b237.md، task-92c9dd21-d951-426b-9f25-709bbff53ef8.md) دارای فیلدهای 'responsibility', 'purpose', 'expected_inputs', 'expected_outputs' و 'interacts_with' خالی هستند.
```
