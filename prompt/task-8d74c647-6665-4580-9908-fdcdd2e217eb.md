...
updated_at: '2026-06-13T08:10:56.570140+00:00'
target_files:
...
1. اگر startTelegram reject شود، خطا از طریق logger.recordError ثبت می‌شود و process.on('unhandledRejection') فعال نمی‌شود
2. تست واحد جدید که با bot ساختگی throw می‌کند تأیید کند هیچ unhandled rejection رخ نمی‌دهد
