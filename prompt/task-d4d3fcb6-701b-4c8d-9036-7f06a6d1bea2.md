...
updated_at: '2026-06-06T07:55:56.629649+00:00'
target_files:
...
1. سیستم آپلود فایل قادر به تشخیص و رد فایل‌هایی با نوع MIME جعلی باشد.
2. یک تست واحد جدید برای سناریوهای جعل نوع MIME اضافه شود.
3. عملکرد آپلود فایل‌های مجاز بدون تغییر باقی بماند.
