...
updated_at: '2026-06-03T06:03:40.562639+00:00'
tags:
- consolidated
- post_verify_merge
---
...
## 🧪 دستورات اعتبارسنجی
- `grep -r "AIzaSy***REDACTED***" frontend/`
- `npm run build && grep -r "AIzaSy***REDACTED***" frontend/dist/`
