---
task_id: a202693f-9c7d-41d6-8f73-e9ef34e1795f
...
created_at: '2026-06-06T07:57:45.619750+00:00'
updated_at: '2026-06-13T08:12:03.355199+00:00'
target_files:
...
## 📋 شرح
در `tests/e2e/test_outcome_metrics.py` (line 78) یک مقدار عددی hard-coded پیدا شد که بدون توضیح/ثابت‌سازی استفاده می‌شود.

## 🔍 جزئیات
- snippet: `assert metrics["chat_success_rate"] == 0.75`
...
---
[scan #2 at 2026-06-13T08:12:03.355157+00:00]
## 📋 شرح
در `tests/e2e/test_outcome_metrics.py` (line 78) یک مقدار عددی hard-coded پیدا شد که بدون توضیح/ثابت‌سازی استفاده می‌شود.
...
- `tests/e2e/test_outcome_metrics.py:78`
