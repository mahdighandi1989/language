---
task_id: d741bf1f-608e-446e-823c-745e5328dd7b
title: حذف Inspector Bridge Script از production
type: security
priority: critical
...
created_at: '2026-05-30T07:41:19.633420+00:00'
updated_at: '2026-06-01T19:04:47.680893+00:00'
target_files:
- frontend/index.html
- frontend/src/App.jsx
---

# حذف Inspector Bridge Script از production
...
1. اسکریپت Inspector Bridge از frontend/index.html حذف شده باشد _(verify: static)_
2. اسکریپت Inspector Bridge از frontend/src/App.jsx حذف شده باشد _(verify: static)_
3. هیچ event listener برای رهگیری کلیک/اسکرول/تایپ در production فعال نباشد _(verify: static)_
4. build پروژه بدون خطا انجام شود _(verify: backend_test)_
