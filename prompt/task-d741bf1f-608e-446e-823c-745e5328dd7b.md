...
updated_at: '2026-05-30T07:41:19.633424+00:00'
target_files:
- frontend/index.html
...
1. اسکریپت Inspector Bridge از frontend/index.html حذف شده باشد
2. اسکریپت Inspector Bridge از frontend/src/App.jsx حذف شده باشد
3. هیچ event listener برای رهگیری کلیک/اسکرول/تایپ در production فعال نباشد
4. build پروژه بدون خطا انجام شود
