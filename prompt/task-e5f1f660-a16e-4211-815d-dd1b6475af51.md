...
updated_at: '2026-06-13T08:12:02.577253+00:00'
target_files:
...
1. A Zod schema (or similar) is defined for the main user data structure.
2. Data written to Firestore adheres to the defined schema.
3. A basic migration function exists to handle schema changes for existing users.
4. New user data is initialized according to the latest schema.
