...
updated_at: '2026-06-13T08:07:28.870980+00:00'
target_files:
...
1. فایل backend/tests/analysisService.test.js ایجاد شود و در اجرای vitest سبز باشد
2. تست مسیر 400 (بدون فایل/متن) وجود داشته باشد
3. حداقل یک تست برای chunking PDF (آستانهٔ 50000) و یک تست برای مسیر isLargeFile صوت با mock File API وجود داشته باشد
4. تستی که اطمینان می‌دهد cleanupTempFiles در مسیر موفق و خطا فراخوانی می‌شود اضافه شود
