...
updated_at: '2026-06-13T08:09:59.542380+00:00'
target_files:
...
1. When Firebase becomes available for a user with existing `localStorage` data, the app prompts for data migration/merge.
2. Data is consistently loaded from either `localStorage` or Firestore, with a clear priority.
3. No data loss occurs when switching between Firebase-configured and non-configured states.
