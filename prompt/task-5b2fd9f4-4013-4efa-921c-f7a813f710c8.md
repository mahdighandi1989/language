---
task_id: 5b2fd9f4-4013-4efa-921c-f7a813f710c8
title: 🆕 فایل جدید `logger.test.js` به هیچ‌جا متصل نیست (orphan)
...
created_at: '2026-06-06T07:59:11.708297+00:00'
updated_at: '2026-06-06T08:07:09.245865+00:00'
target_files:
- frontend/src/utils/logger.test.js
---

# 🆕 فایل جدید `logger.test.js` به هیچ‌جا متصل نیست (orphan)
...
## 🔍 جزئیات
- 📂 added: `frontend/src/utils/logger.test.js`
- 🔥 risk: **medium**
...
---
[scan #2 at 2026-06-06T07:59:11.762277+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `backend/tests/flashcardService.test.js`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
...
## 🌐 نقشهٔ وابستگی‌ها
فایل جدید `frontend/src/utils/logger.test.js` بدون companion.
...
1. بررسی کن فایل `frontend/src/utils/logger.test.js` به چه companion ای نیاز دارد و آن را ایجاد یا متصل کن.
...
3. scan بعدی این فایل را orphan گزارش نمی‌کند _(verify: backend_test)_
