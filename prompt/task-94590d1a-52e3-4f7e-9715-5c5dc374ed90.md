...
updated_at: '2026-06-06T07:57:19.290558+00:00'
target_files:
...
1. همهٔ مسیرهای /api در یک‌جا (routes layer) قابل کشف باشند یا تصمیم خلاف آن در routes/index.js مستند شده باشد
2. رفتار rate-limit مسیرهای telegram (آیا تحت generalLimiter هست یا نه) به‌صراحت در کامنت یا docs ثبت شود
3. تست‌های موجود backend/tests/test_telegram_service.js همچنان pass شوند
