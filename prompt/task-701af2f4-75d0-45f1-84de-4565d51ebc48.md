...
updated_at: '2026-06-13T08:10:56.533669+00:00'
target_files:
...
1. فقط یک پیاده‌سازی واقعی App وجود دارد؛ دیگری حذف یا re-export است
2. main.jsx و README به مسیر واحد ارجاع می‌دهند
3. تست‌های frontend بدون شکست اجرا می‌شوند
