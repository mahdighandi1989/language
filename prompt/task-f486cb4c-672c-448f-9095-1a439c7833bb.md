...
updated_at: '2026-06-13T08:12:02.494689+00:00'
target_files:
...
1. در صورت عدم پیکربندی `GEMINI_API_KEY`، درخواست به مسیرهای Gemini با کد وضعیت 503 پاسخ دهد.
2. پیام خطا همچنان `API key not configured` باشد.
