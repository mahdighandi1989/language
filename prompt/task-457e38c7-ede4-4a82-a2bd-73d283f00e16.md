...
updated_at: '2026-06-06T07:57:19.252886+00:00'
target_files:
...
1. بررسی شد `backend/server.js` چه API ای از `backend/controllers/index.js` می‌خواهد
2. اگر API در `backend/controllers/index.js` نیست، اضافه شد
