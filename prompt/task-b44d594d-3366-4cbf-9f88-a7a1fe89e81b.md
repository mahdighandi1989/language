...
updated_at: '2026-06-06T07:59:12.052370+00:00'
target_files:
...
1. مشخص شد فایل dead است یا entry point/dynamic
2. اقدام مناسب: حذف یا مستندسازی
3. تست‌های مربوطه (در صورت حذف) هم حذف شدند
