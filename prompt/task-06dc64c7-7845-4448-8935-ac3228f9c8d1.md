...
updated_at: '2026-06-13T08:16:02.987668+00:00'
target_files:
...
1. تمام پرامپت‌های پیش‌فرض AI در `backend/models/prompts.js` تعریف شده باشند. _(verify: static)_
2. یک endpoint در بک‌اند (`/api/prompts`) برای ارائه این پرامپت‌ها وجود داشته باشد. _(verify: api_response)_
3. فرانت‌اند پرامپت‌های پیش‌فرض را از این endpoint واکشی کند و فقط `customPrompts` را به صورت محلی مدیریت کند. _(verify: ui_interaction)_
4. رفتار AI در چت و تحلیل بدون تغییر باقی بماند. _(verify: backend_test)_
