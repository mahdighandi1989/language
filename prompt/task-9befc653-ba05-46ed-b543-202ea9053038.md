...
updated_at: '2026-06-06T07:57:19.307382+00:00'
target_files:
...
1. یک منبع واحد یا یک تست consistency برای پرامپت‌های مشترک live-voice وجود داشته باشد
2. تغییر در یک پرامپت live در بک‌اند باعث شکست تست شود اگر فرانت‌اند همگام نشود (یا برعکس)
3. هیچ کلید live-voice پرامپتی در یک طرف باشد که در طرف دیگر نباشد
