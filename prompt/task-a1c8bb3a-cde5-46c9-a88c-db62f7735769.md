...
updated_at: '2026-06-13T08:16:58.690006+00:00'
target_files:
...
1. فایل backend/tests/geminiService.test.js ایجاد و سبز شود _(verify: backend_test)_
2. تست استخراج متن موفق و تست fallback رشتهٔ خالی وجود داشته باشد _(verify: backend_test)_
3. تست throw روی response.ok=false وجود داشته باشد _(verify: backend_test)_
4. تست اینکه deleteGeminiFile روی خطا throw نمی‌کند وجود داشته باشد _(verify: backend_test)_
