...
updated_at: '2026-06-13T08:12:02.537591+00:00'
target_files:
...
1. `backend/middleware/firebaseAuth.js` no longer directly accesses `process.env.FIREBASE_PROJECT_ID`.
2. Firebase Admin SDK is initialized once and passed or accessed consistently across the backend.
3. All Firebase-dependent services (auth, Telegram) function correctly.
