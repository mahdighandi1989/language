---
task_id: 53d06277-1536-45e9-9391-0c5978d74347
title: 'dependency بلااستفاده: PyYAML (python)'
type: cleanup
priority: medium
...
created_at: '2026-06-06T07:57:45.498098+00:00'
updated_at: '2026-06-13T08:12:03.334917+00:00'
---

# dependency بلااستفاده: PyYAML (python)

## Raw Idea

## 📋 شرح
package `PyYAML` در `` declare شده ولی در هیچ import کدبیس مصرف نمی‌شود.
...
- نام package: `PyYAML`
- زبان: `python`
- علت: in requirements but no 'import pyyaml' or 'from pyyaml' found
---
[scan #2 at 2026-06-06T07:57:45.536793+00:00]
## 📋 شرح
package `autoprefixer` در `` declare شده ولی در هیچ import کدبیس مصرف نمی‌شود.

## 🤔 چرا مهم است
dependency بلااستفاده باعث: (۱) bundle size بزرگ، (۲) attack surface بیشتر برای vulnerabilities، (۳) supply chain risk.

## 🔍 جزئیات
- نام package: `autoprefixer`
- زبان: `node`
- علت: in packag
---
[scan #3 at 2026-06-06T07:57:45.555168+00:00]
## 📋 شرح
...
---
[scan #4 at 2026-06-06T07:57:45.574336+00:00]
## 📋 شرح
package `pdf-parse` در `` declare شده ولی در هیچ import کدبیس مصرف نمی‌شود.

## 🤔 چرا مهم است
dependency بلااستفاده باعث: (۱) bundle size بزرگ، (۲) attack surface بیشتر برای vulnerabilities، (۳) supply chain risk.

## 🔍 جزئیات
- نام package: `pdf-parse`
- زبان: `node`
- علت: in package.json
---
[scan #5 at 2026-06-06T07:57:45.597618+00:00]
## 📋 شرح
package `postcss` در `` declare شده ولی در هیچ import کدبیس مصرف نمی‌شود.
...
- نام package: `postcss`
- زبان: `node`
- علت: in package.json but
---
[scan #6 at 2026-06-06T07:57:45.619430+00:00]
## 📋 شرح
package `tailwindcss` در `` declare شده ولی در هیچ import کدبیس مصرف نمی‌شود.

## 🤔 چرا مهم است
dependency بلااستفاده باعث: (۱) bundle size بزرگ، (۲) attack surface بیشتر برای vulnerabilities، (۳) supply chain risk.

## 🔍 جزئیات
- نام package: `tailwindcss`
- زبان: `node`
- علت: in package.
...
- [ ] `PyYAML` در هیچ direct import مصرف نمی‌شود + هیچ transitive dep ای آن را require نمی‌کند
...
1. گام ۱: `npm/pip list --depth=0` و grep import روی `PyYAML`.
...
1. `PyYAML` در هیچ direct import مصرف نمی‌شود + هیچ transitive dep ای آن را require نمی‌کند _(verify: static)_
