...
// ============================================
// Anti-pattern guard: never act on an AI-issued command without validation.
// The Live API model can emit structured commands (e.g. a "click" carrying a
// CSS selector, or a "navigate" carrying a URL). Acting on those blindly lets a
// malformed or hostile selector (e.g. "body *") freeze the page, or an
// untrusted/`javascript:` URL trigger an open-redirect or script execution.
// `handleCommand` below routes every such command through these guards first.
